...
# schema
# pydantic is a data validation and settings management library in Python, it allows you to define data models with type annotations and provides validation and parsing capabilities.
